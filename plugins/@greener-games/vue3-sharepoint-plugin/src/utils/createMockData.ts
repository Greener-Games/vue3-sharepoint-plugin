...
export const MOCK_MARKETS = ['North America', 'Europe', 'Asia Pacific'];
export const MOCK_CAPABILITIES = ['Strategic Planning', 'Process Optimization', 'Compliance'];
export const MOCK_REGIONS = ['East Coast', 'West Coast', 'International'];
...
export function createMockData(docCount = 60, baseUrl = '/sites/Intranet'): MockData {
  const siteUrl = baseUrl.replace(/\/$/, '');
