...
```typescript
import { MockSharePointClient, createMockUser, type MockData } from 'vue3-sharepoint-plugin';
...
const results = await searchCtx.execute({
  ...
  selectFields: [
    'Title',
    'Path',
    'HitHighlightedSummary', // Search Props
    'Author/Title',
    'Author/Email', // List Expansions (auto-routed to List)
    'Department/Title',
  ],
